...
class Component(Resource):
    ...
    def post(self):
        ...
        category = STRUCTURES[os][branch]['component_structure'].query.all()
        data, errors = SCHEMAS[os][branch]['components_schema'].dump(category)
        if errors:
    ...
    def put(self):
        ...
        for data in json_data:
            category = STRUCTURES[os][branch]['component_structure'].query.filter_by(component_id=data['component_id']).first()
            if category:
